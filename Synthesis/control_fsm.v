module control_fsm (
    ...
    input wire mmio_addr, // 1 = 0xFF00 (SW), 0 = 0xFF02 (LW)
    ...
    begin : OUTPUT
        ...
        case (state)
            ...
            SHIFT_LOOP: begin
                ...
                case (opcode)
                    OP_LSL: 
                        shifter_op <= SHIFT_LSL;

                    OP_LSR: 
                        shifter_op <= SHIFT_LSR;

                    OP_MAC: 
                        shifter_op <= SHIFT_MAC;

                    OP_CLZ: 
                        shifter_op <= SHIFT_CLZ;
