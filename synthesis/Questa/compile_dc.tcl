# Tcl file for Synthesis for QuestaSim (ins_mem.v as blackbox)
...
set filename [format "%s%s"  $my_toplevel "_questa.vh"]
write -f verilog -output $filename

set filename [format "%s%s"  $my_toplevel "_questa.sdc"]
write_sdc $filename
